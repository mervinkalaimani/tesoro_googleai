...
// the old IDs would show every car twice next to the renamed rows. v7 also
// drops caches written before mix numbers moved to Case Number.
const lsKey = (uid: string) => `dg.carsOverlay.v4.${uid}`;
const cacheKey = (uid: string) => `dg.carsCache.v7.${uid}`;
const tsKey = (uid: string) => `dg.carsCache.ts.v7.${uid}`;
